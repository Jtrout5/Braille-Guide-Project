...
braille = {
    ...
    "!":  {"type": "punctuation", "value": [(2,3,5)]},          # exclamation mark
    "\"": {"type": "punctuation", "value": [(5,), (2,3,5,6)]},  # opening/closing quotes (UEB uses paired)
    "#":  {"type": "punctuation", "value": [(3,4,5,6)]},        # number indicator (already used for digits)
    "$":  {"type": "punctuation", "value": [(4,),(2,3,4)]},                 # no official UEB symbol
    "%":  {"type": "punctuation", "value": [(4,6),(3,5,6)]},                 # no official UEB symbol
    "•":  {"type": "punctuation", "value": [(4,5,6),(2,5,6)]},  # Annoying one
    "&":  {"type": "punctuation", "value": [(1,2,3,4,6)]},      # ampersand
    "'":  {"type": "punctuation", "value": [(3,)]},             # apostrophe
    "(":  {"type": "punctuation", "value": [(5,), (1,2,6)]},    # opening parenthesis
    ")":  {"type": "punctuation", "value": [(5,), (3,4,5)]},    # closing parenthesis
    "*":  {"type": "punctuation", "value": [(5,),(3,5)]},          
    "+":  {"type": "punctuation", "value": [(3,4,6)]},          # plus sign
    ",":  {"type": "punctuation", "value": [(2,)]},             # comma
    "-":  {"type": "punctuation", "value": [(3,6)]},            # hyphen
    ".":  {"type": "punctuation", "value": [(2,5,6)]},          # period
    "/":  {"type": "punctuation", "value": [(3,4)]},            # slash
    ":":  {"type": "punctuation", "value": [(2,5)]},            # colon
    ";":  {"type": "punctuation", "value": [(2,3)]},            # semicolon
    "<":  {"type": "punctuation", "value": [(4,),(1,2,6)]},                 # no official UEB symbol
    "=":  {"type": "punctuation", "value": [(5,),(2,3,5,6)]},        # equals sign
    ">":  {"type": "punctuation", "value": [(4,),(3,4,5)]},                 # no official UEB symbol
    "?":  {"type": "punctuation", "value": [(2,3,6)]},            # question mark
    "@":  {"type": "punctuation", "value": [(4,),(1,)]},                 # no official UEB symbol
    "[":  {"type": "punctuation", "value": [(5,), (1,2,6)]},    # opening bracket (same as parenthesis)
    "\\": {"type": "punctuation", "value": [((4,5,6),(1,6))]},                 # backslash — no UEB symbol
    "]":  {"type": "punctuation", "value": [(5,), (3,4,5)]},    # closing bracket
    "^":  {"type": "punctuation", "value": [(4,5),(1,4,6)]},                 # caret — no UEB symbol
    "_":  {"type": "punctuation", "value": [(4,6),(3,6)]},                 # underscore — no UEB symbol
    "{":  {"type": "punctuation", "value": [(4,5,6),(1,2,6)]},                 # no UEB symbol
    "}":  {"type": "punctuation", "value": [(4,5,6),(3,4,5)]},                 # no UEB symbol
    "°":  {"type": "punctuation", "value": [(4,5),(2,4,5)]},                 # degree sign — no UEB symbol
    ...
    "world":     {"type": "initial_letter_contractions", "value": [(4,5,6),(2,4,5,6)]},   # NOT an official contraction
